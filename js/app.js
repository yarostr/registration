 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".past__slider")) new core(".past__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".timetable__slider")) new core(".timetable__slider", {
                ...
                slidesPerGroup: 2,
                navigation: {
                    prevEl: ".timetable-swiper-button-prev",
                    nextEl: ".timetable-swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".speakers__slider")) new core(".speakers__slider", {
                modules: [ Navigation ],
                slidesPerView: 2,
                spaceBetween: 20,
                speed: 800,
        ...
        document.getElementById("more").onclick = function() {
            document.getElementById("treatment").classList.remove("none");
            document.getElementById("close").classList.remove("none");
            document.getElementById("more").classList.add("none");
        };
        document.getElementById("close").onclick = function() {
            document.getElementById("treatment").classList.add("none");
            document.getElementById("close").classList.add("none");
            document.getElementById("more").classList.remove("none");
        };
        document.getElementById("close__burger").onclick = function() {
            document.getElementById("burger__all").classList.remove("burger__position");
        };
        document.getElementById("burger").onclick = function() {
            document.getElementById("burger__all").classList.add("burger__position");
        };
        document.getElementById("more2").onclick = function() {
            document.getElementById("description").classList.add("none");
            document.getElementById("all_description").classList.remove("none");
        };
        document.getElementById("more_closed").onclick = function() {
            document.getElementById("description").classList.remove("none");
            document.getElementById("all_description").classList.add("none");
        };
        window["FLS"] = true;
        isWebp();
        formFieldsInit({
